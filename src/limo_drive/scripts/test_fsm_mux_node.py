...
class FSMMuxNode:
    ...
    def __init__(self):
        ...
        # ----- Mission3 타이밍 파라미터 -----
        self.m3_phase_time          = rospy.get_param("~m3_phase_time", 14)   # 첫 LKAS cmd 이후 기준
        ...
        self.v2x_phase_time2    = rospy.get_param("~v2x_phase_time", 5.5)
        ...
        self.v2x_turn_yaw        = rospy.get_param("~v2x_turn_yaw", -0.00)
